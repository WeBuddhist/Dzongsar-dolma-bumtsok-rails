...
description: >
  ...
  colophons/back matter), driven by the bundled 4-SYSTEM/Skills/format-sanskrit-root-text/scripts/apply.py
...
(`4-SYSTEM/Guidelines/annotation-conventions.md` §1b) to a Sanskrit root-text `.md` file. Work on a copy
in `0-INBOX/temp/` until the zones are confirmed. It is **not** for commentaries or
...
The skill uses `4-SYSTEM/Skills/format-sanskrit-root-text/scripts/apply.py`. Always follow this order:
...
```bash
python3 "4-SYSTEM/Skills/format-sanskrit-root-text/scripts/apply.py" audit "<path-to-file.md>"
```
...
```bash
python3 "4-SYSTEM/Skills/format-sanskrit-root-text/scripts/apply.py" apply "<path-to-file.md>"
```
