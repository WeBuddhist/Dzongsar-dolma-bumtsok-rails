...
stage:rails|F00AA0|Stage 2 - Rails
...
(Bodies: paste from `the filled example for your first text` / `02-new-text-template.md`, or keep them in a `drafts/` folder as files and pass `--body-file`.)
